package megaminds.findmedicine.splashscreen;
...
import megaminds.findmedicine.MainActivity;
import megaminds.findmedicine.R;
import megaminds.findmedicine.font.FontelloTextView;
			...
			protected void onPostExecute(Void result) {
               ...
               // gpsOnOff();
				if(rememberMe==true){
					...
					Intent i = new Intent(SplashScreenLauncherActivity.this, MainActivity.class);
